let Won = 0,
  Lost = 0;
let GameOver = false;
let U = document.getElementsByClassName("L1");
let M = document.getElementsByClassName("L2");
let L = document.getElementsByClassName("L3");
...
function Result() {
  if (U[0].value == "X" && U[1].value == "X" && U[2].value == "X") {
    ...
    GameOver = true;
    document.getElementById("Res").style =
      "color:#05750A;background-color:#F6FAF1;";
...
function Lose() {
  ...
  document.getElementById("Res").style =
    "background-color:#BF5B5B;color:black;";
  Lost++;
  Reached = true;
  UpdateScore();
}
